...
public class SecurityConfig {
    ...
    private static final String[] AUTH_WHITELIST = {
            ...
            ,"/actuator/health","/confirmPurchase/**", "/userMagazine/**", "/orders/getNonUser", "/orders/nonUserCreate", "/orders/forCancel", "/review/**","/review/nonUserCreat", "/delivery/getInvoiceNumber"
    }; //더 열어둘 엔드포인트 여기에 추가
